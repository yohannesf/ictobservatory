...
from .views.admin_views import (GeneralIndicatorCreateView, GeneralIndicatorListView, GeneralIndicatorUpdateView, IndicatorCreateView, IndicatorListtableView, IndicatorUpdateView,
                                FocusAreaListView, FocusAreaCreateView, FocusAreaUpdateView,
                                indicator_list_view, manage_indicatorassignment, publish_data)

from .views.indicator_data_views import (dataentryprogress, manage_general_indicatordata, manage_indicatordata, manage_indicatordata_organisation,
...
urlpatterns = [
    ...
    #     path('manage-indicators/', IndicatorListView.as_view(),
